	...
	$.widget( "custom.combobox", {
		...
		_createShowAllButton: function() {
			...
			$( "<a>" ).attr( "tabIndex", -1 )
					  ...
					  .tooltip()
					  .appendTo( this.wrapper ).button({ icons: { primary: "ui-icon-triangle-1-s" }, text: false })
		...
		_removeIfInvalid: function( event, ui ) {
			...
			this.input.val( "" ).attr( "title", value + " não corresponde a nenhum item" ).tooltip( "open" );
			this.element.val( "" );
			this.element.change();
