...
(function(c) {
					...
					.each(function() {
						...
						if (h) {
							...
							i.queueData = {
								...
								uploadQueue : [],
								errorMsg : "Alguns arquivos não puderam ser adicionados:"
							};
							i.original = m;
							i.wrapper = l;
							i.button = f;
	...
	var a = {
		onDialogOpen : function() {
			var d = this.settings;
			this.queueData.errorMsg = "Alguns arquivos não puderam ser adicionados:";
			...
			if (c.inArray("onSelectError", e.overrideEvents) < 0) {
				...
				case SWFUpload.QUEUE_ERROR.QUEUE_LIMIT_EXCEEDED:
					if (e.queueSizeLimit > f) {
						this.queueData.errorMsg += "\nO número de arquivos selecionados excedeu o limite ("
								+ f + ").";
					} else {
						this.queueData.errorMsg += "\nO número de arquivos selecionados excedeu o limite ("
								+ e.queueSizeLimit + ").";
		...
		onUploadError : function(e, i, h) {
			...
			case SWFUpload.UPLOAD_ERROR.UPLOAD_LIMIT_EXCEEDED:
				alert("O limite de arquivos para upload foi atingido (" + h + ").");
